...
uses
  ...
  CylinderMap in 'Libs\Wredosoft\CylinderMap.pas',
  IntEdit in 'Libs\Wredosoft\IntEdit.pas',
  ImageBtn in 'Libs\Wredosoft\ImageBtn.pas',
  ColorBtn in 'Libs\Wredosoft\ColorBtn.pas',
  Painter in 'Libs\Wredosoft\Painter.pas',
  ...
  AtlaDate in 'U_Base\AtlaDate.pas',
  uNewGame in 'U_Manager\uNewGame.pas',
  uMgrOptions in 'U_Manager\uMgrOptions.pas',
  uSelAmount in 'U_Orders\uSelAmount.pas',
  uClaim in 'U_Orders\uClaim.pas',
  uBuy in 'U_Orders\uBuy.pas',
  uMail in 'U_Base\uMail.pas',
  uTradeStructs in 'U_Tools\uTradeStructs.pas',
  uRegionStat in 'U_Tools\uRegionStat.pas',
  uGates in 'U_Tools\uGates.pas',
  uItemStats in 'U_Tools\uItemStats.pas',
  uMemo in 'U_Tools\uMemo.pas',
  RegCode in 'U_Base\RegCode.pas',
  uRegistration in 'U_Base\uRegistration.pas' {RegForm},
  PowerGrid in 'Libs\Wredosoft\PowerGrid.pas',
  MemoEx in 'Libs\MemoEx\MemoEx.pas',
  MemoExScrollBar in 'Libs\MemoEx\MemoExScrollBar.pas',
  MemoExXPCompat in 'Libs\MemoEx\MemoExXPCompat.pas',
  MemoExClipUtils in 'Libs\MemoEx\MemoExClipUtils.pas';
